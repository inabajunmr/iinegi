...
var author$project$Main$Model = F4(
	function (input, negiState, files, currentTime) {
		return {currentTime: currentTime, files: files, input: input, negiState: negiState};
	});
...
var author$project$Main$init = function (currentTime) {
	return _Utils_Tuple2(
		...
		elm$http$Http$get(
			{
				expect: A2(elm$http$Http$expectJson, author$project$Main$Received, author$project$Main$negisDecoder),
...
var author$project$Main$upload = function (files) {
	var _n0 = elm$core$List$head(files);
	if (_n0.$ === 'Just') {
		var file = _n0.a;
		return elm$http$Http$request(
			{
				body: elm$http$Http$multipartBody(
					_List_fromArray(
						[
							A2(elm$http$Http$stringPart, 'description', 'Test'),
				...
				if (msg.a.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								negiState: author$project$Main$Loaded(negi)
							}),
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								negiState: author$project$Main$Failed(e)
							}),
						elm$core$Platform$Cmd$none);
				}
			case 'Uploaded':
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Events$on,
						'change',
						A2(elm$json$Json$Decode$map, author$project$Main$SelectImage, author$project$Main$filesDecoder))
					]),
				_List_Nil),
				A2(
